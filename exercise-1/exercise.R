...
make_year_filter <- function(year_choice, make_choice) {
  filtered_one <- vehicles[vehicles$year == year_choice, ]
  filtered_two <- filtered_one[filtered_one$make == make_choice, ]
  filtered_two[filtered_two$hwy == max(filtered_two$hwy), "model"]
}
